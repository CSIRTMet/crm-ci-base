...
-->
</style> <div align="center" class="style6">LISTADO DE CAMPANAS
    </div>
<div id="Layer1">
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="x-grid3-row-alt">
    <tr>
	<td>
	<a href="<?php echo base_url() ?>index.php/campana/ingresar_campana">Nueva Campana
	</td>
    </tr>
    <tr>
...
<td>
<a href="<?php echo base_url() ?>index.php/campana/edita_campana/<?php echo $item->id_campana?>">Editar
</td>
</tr>
<tr>
<?php 
