...
<head>
  ...
  <title>Kubo Segmentador Preview
  </title>
...
<table border="1" cellspacing="2" cellpadding="2" align="center" width="90%" bgcolor= "#EEEEEE">
    ...
    <th nowrap><small>Fec. Agendada</small></th>
    
    <th nowrap><small>Fec. ult. gestion</small></th>
    <th nowrap><small>Hora ult. gestion</small></th>
    <th nowrap><small>Ult. gestion</small></th>

    <th nowrap><small>Mejor gestion</small></th>

    <th nowrap><small>Ciudad</small></th>
	<th nowrap><small>Comuna</small></th>
    <th nowrap><small>Region</small></th>

    <th nowrap><small>Nro. gestiones</small></th>
   
	<th nowrap><small>Prioridad</small></th>
    ...
    <tr>
        ...
        <td nowrap><?php  
		 ...
		 ?></td>
        <td nowrap><?php echo $row->fecha_agendada ?></td>

        <td nowrap><?php echo $row->fecha_ultima_gestion ?></td>
        <td nowrap><?php echo $row->hora_ultima_gestion ?></td>
         <td nowrap><?php echo $row->ultima_gestion ?></td>

        <td nowrap><?php echo $row->mejor_gestion ?></td>
     
        <td nowrap><?php echo $row->nombre_ciudad ?></td>
        <td nowrap><?php echo $row->nombre_comuna ?></td>
        <td nowrap><?php echo $row->nombre_region ?></td>
       
        <td nowrap><?php echo $row->numero_gestiones ?></td>
      
        <td nowrap><?php echo $row->prioridad ?></td>
...
<table border="1" cellspacing="2" cellpadding="2" align="center" width="90%" bgcolor= "#EEEEEE">
	<thead>
	<tr>
    <th nowrap><small>Con Compromiso</small></th>
	<th nowrap><small>Con Pago</small></th>
    <th nowrap><small>Estado</small></th>
    <th nowrap><small>Fec. Agendada</small></th>
    <th nowrap><small>Inicio cartera</small></th>
    ...
    <th nowrap><small>Nro. gestiones</small></th>
    <th nowrap><small>Ofertas</small></th>
	<th nowrap><small>Prioridad</small></th>
    <th nowrap><small>Rut</small></th>
    ...
    <tr>
        ...
        <td nowrap><?php echo ($row->deuda_con_compromiso_mes == 0) ?   "No" :   "Si"; ?></td>
        <td nowrap><?php echo ($row->deuda_con_pago_mes == 0) ?   "No" :   "Si"; ?></td>
        ...
        <td nowrap><?php  
		 ...
		 ?></td>
        <td nowrap><?php echo $row->fecha_agendada ?></td>
        <td nowrap><?php echo $row->fecha_inicio_cartera ?></td>
        ...
        <td nowrap><?php echo $row->numero_gestiones ?></td>
        <td nowrap><?php echo $row->ofertas ?></td>
        <td nowrap><?php echo $row->prioridad ?></td>
        <td nowrap><?php echo $row->rut ?></td>
