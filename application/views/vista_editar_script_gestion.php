...
<div class="ui-layout-north"> 
	...
	<ul class="toolbar" style="width:100%; padding-left:0px; padding-right:0px"> 
      ...
      <div align="center"><span style="color:#FFF" ><strong>SCRIPTS DE LA  CAMPAÑA</strong></span> </div>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="x-progress-inner" >
               <tr>
                 <td  class=""><strong>EDITAR SCRIPT</strong></td>
  ...
  <div id="Layer1">
	...
	echo form_open("script_gestion/editar_script", $atributors);?>
  <?php echo validation_errors();?>
  <?php if(isset($mensaje)) echo $mensaje; ?>
  
  <input type="hidden" name="id_script" value="<?php echo $script->id_script; ?>" />
  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="x-border-layout-ct">
    ...
    <tr>
      ...
      <td width="910" class="x-grid3-row-selected"><p>
      <input name="nombre" type="text" id="nombre" size="50" maxlength="30" class="label" value="<?php echo $script->nombre; ?>" ></td>
    </tr>
    <tr>
      <td class="x-grid3-row-over"><strong>DESCRIPCION</strong></td>
      <td class="x-grid3-row-selected"><input name="descripcion" type="text" id="descripcion"  value="<?php echo $script->descripcion; ?>" size="50" maxlength="50" class="label"    
       ></td>
    </tr>
    <tr>
      ...
      <td nowrap="nowrap" class="x-grid3-row-selected">
       ...
       <?php  $options2 = array(
			...
			echo form_dropdown('estado', $options2, set_value('estado', $script->estado));
      ?>
     </td>
    </tr>
    <tr>
