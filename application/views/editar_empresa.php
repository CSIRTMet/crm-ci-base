...
-->
</style> <div align="center" class="style6">EDITAR EMPRESAS
    </div>
<div id="Layer1">
...
<form method="post" action="<?php echo base_url() ?>index.php/empresa/actualiza_empresa" enctype="multipart/form-data" />
    <tr>
      <td colspan="2" class="x-combo-list-hd">Nombre Empresa </td>
      <td colspan="2" class="x-combo-list-hd">Codigo</td>
    </tr>
    <tr>
      <td colspan="2"><input name="txt_id_empresa" type="hidden" class="x-form-field" id="txt_id_empresa" value="<?php echo $id_empresa;?>"/>
        <input name="txt_nombre" type="text" class="x-form-field" id="txt_nombre" value="<?php echo $nombre;?>"/>      </td>
      <td colspan="2">
        <input name="txt_codigo" type="text" id="txt_codigo" size="16" value="<?php echo $codigo;?>" />      </td>
    </tr>	
    <tr>
      <td width="43%">&nbsp;</td>
