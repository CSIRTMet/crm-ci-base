...
*html .popup_block {
	position: absolute;
		...
		<script type="text/javascript" charset="utf-8">
			function mostrar_detalle_auditoria_por_dia(id_usuario_calificacion,todo,agente_auditor){
			...
			var url='<?php echo base_url() ?>index.php/venta/mostrar_detalle_auditoria_por_dia/';
			$.post(url+r, { 
				'todo':todo
				,'id_usuario_calificacion':id_usuario_calificacion
				,'agente_auditor': agente_auditor
			}, function(data) {
...
<select name="select_anio" id="select_anio">
	...
	<input type="submit" name="enviar"  onclick="traer_resumen_auditoria_mensual_campana_mkt()"   id="enviar" value="Cambiar Filtro" />
</form>
<div class="ui-layout-north">

<ul class="toolbar" style="width:100%; padding-left:0px; padding-right:0px"> 

      <div align="center"><span style="color:#FFF" ><strong>Resumen Auditoria Mensual Ventas Por Campa&ntilde;a</strong></span> </div>
...
?>		
      <tr id="<?php echo $item->id_usuario_calificacion; ?>" class="activo1">
		<td><?php echo $i++; ?></td>
		<td><?php echo $anio_mes; ?></td>
		<td><a href="#" onClick="mostrar_detalle_auditoria_por_dia('<?php echo $item->id_usuario_calificacion; ?>','<?php echo $todo?>','<?php echo $item->agente_auditor; ?>')"><?php echo $item->cantidad; ?></a></td>
		<td><?php echo $item->agente_auditor; ?></td>
		</tr>
		  <?php endforeach;?>
		<tr>
		<td>&nbsp;</td>
