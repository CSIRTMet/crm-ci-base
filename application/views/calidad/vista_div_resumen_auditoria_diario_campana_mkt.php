...
*html .popup_block {
	position: absolute;
		...
		function mostrar_detalle_auditoria_del_dia(id_usuario_calificacion,dia,agente_auditor){
			...
			var url='<?php echo base_url() ?>index.php/venta/mostrar_detalle_auditoria_del_dia/';
			$.post(url+r, { 
				'dia':dia
...
<ul class="toolbar" style="width:100%; padding-left:0px; padding-right:0px"> 
      ...
      <div align="center"><span style="color:#FFF" ><strong><?php echo $agente_auditor;?></strong></span> </div>
...
<?php echo validation_errors(); ?>
	...
	?>			
      <tr id="<?php echo $item->dia; ?>" class="activo1">
		...
		<td><a href="#" onClick="mostrar_detalle_auditoria_del_dia('<?php echo $id_usuario_calificacion; ?>','<?php echo $item->dia?>','<?php echo $agente_auditor; ?>')"><?php echo $item->cantidad; ?></a></td>
		</tr>
		  <?php endforeach;?>
		<tr>
		<td>&nbsp;</td>
