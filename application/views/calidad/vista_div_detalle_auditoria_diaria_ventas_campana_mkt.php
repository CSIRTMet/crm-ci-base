...
<?php echo validation_errors(); ?>
			...
			<div id="demo">
			  ...
			  <table width='100%' cellpadding="0" cellspacing="0" border="0" class="display" id="grilla">
	<thead>
		<tr>
      		<th width="1%">ID</th>
			<th width="1%">CODGESTION</th>
			<th width="1%">ANEXO</th>
			<th width="1%">FONOS_CL</td>
			<th width="7%">EJECUTIVO</th>
			<th width="1%">RUT</th>
			<th width="1%">FECHA VENTA</th>
			<th width="1%">FONO LLAMADO</th>
			<th width="1%">GRABACION</th>
	...
	<tbody>
        <?php $i=1; foreach($ventas as $item):
			...
			switch($item->calificacion_auditoria){
				case  0: $calificacion = "Venta Pendiente de Auditor&iacute;a";
					break;
				case  1: $calificacion = "Venta V&aacute;lida";
					break;
				case  2: $calificacion = "Venta Rechazada";
					break;
				default: $calificacion = "Venta Pendiente de Auditor&iacute;a";
			}
	  ?>
		<tr>
		  ...
		  <?php
				...
				$grabacion = preg_replace($patron, $sustitucion, $grb);
			?>
				<a href="<?php echo $grabacion; ?>" title="Para descargar el audio, presione boton derecho, luego guardar enlace como...">
	  ...
	  <?php  
	  	if($tipo_usuario == 5 && $item->calificacion_auditoria == 0){
	  ?>
		<td width="1" height="1">
	...
	?>
	  ...
	  <td width="1" height="1">
	  	  <a href='#' title="<?php echo "Observacion_calificacion_auditoria = [$item->observacion_calificacion_auditoria]"; echo "\n";?>">ver</a>
	  </td>
	  <?php
	  }
	  ?>
